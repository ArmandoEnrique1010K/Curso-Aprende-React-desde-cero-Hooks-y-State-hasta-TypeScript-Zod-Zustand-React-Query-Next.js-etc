...
function App() {
  ...
  return (
    <>
      ...
      {/* Si intentas pasarle cart como valor a la prop cartTotal, aparecera un error indicando que esperara que pasara un number. Typescript se encarga de mostrar los errores antes de compilarlo */}
